...
def test_model(model, dataloader, device):
    ...
    metrics = {}
    output_dir = "./classification2_andrea/confusion_matrices"  # Directory per salvare le matrici di confusione
...
if __name__ == "__main__":
    ...
    data_dir = './dataset'
    checkpoint_path = './classification_andrea/models/resnet50.pth'
